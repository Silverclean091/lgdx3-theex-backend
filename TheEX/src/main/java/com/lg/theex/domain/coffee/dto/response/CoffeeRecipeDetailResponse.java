...
@Getter
@Builder
public class CoffeeRecipeDetailResponse {
    ...
    public static CoffeeRecipeDetailResponse from(CoffeeRecipeEntity entity) {
        return CoffeeRecipeDetailResponse.builder()
    ...
    public static CoffeeRecipeDetailResponse from(NoneCoffeeRecipeEntity entity) {
        return CoffeeRecipeDetailResponse.builder()
                .recipeId(entity.getRecipeId())
